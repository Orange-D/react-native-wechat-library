...
Pod::Spec.new do |s|
  ...
  React-Native(iOS/Android) functionalities include WeChat Login, Share, Favorite and Payment 
   DESC
  s.author       = { "orange-d" => "hope.910602@gmail.com" }
  s.homepage     = "https://github.com/Orange-D/react-native-wechat-library"
  s.license      = "MIT"
  s.platform     = :ios, "9.0"
  s.source       = { :git => "https://github.com/Orange-D/react-native-wechat-library.git", :tag => "master" }
